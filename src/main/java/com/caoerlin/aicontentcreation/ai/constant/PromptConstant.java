package com.caoerlin.aicontentcreation.ai.constant;
...
public interface PromptConstant {
    ...
    String ARTICLE_TITLE_AGENT_PROMPT = """
            ...
            根据以下选题,生成 3-5 个爆款文章标题(主标题 + 副标题)方案:
            选题：{topic}
    ...
    /**
     * 智能体2：用户修改建议（动态插入到 ARTICLE_OUTLINE_AGENT_PROMPT）
     */
    String ARTICLE_OUTLINE_AGENT_USER_DESCRIPTION_PROMPT = """
            
            用户要求补充内容{userDescription}
            请在大纲中充分体现用户的补充需求。
            """;
