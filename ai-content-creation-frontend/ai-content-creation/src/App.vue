...
:root {
  ...
  --gradient-hero: linear-gradient(180deg, #e0f2fe 0%, #ffffff 100%);
  --gradient-hero-dark: linear-gradient(180deg, #075985 0%, #0c4a6e 100%);
  ...
  --glass-bg-sky: rgba(224, 242, 254, 0.8);
